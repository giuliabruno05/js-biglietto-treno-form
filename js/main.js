...
function() {
    ...
    let userChilometri = document.querySelector("#userKm").value;
    console.log(userChilometri);


    //chiedere al passegero l'età
    let userEta = document.querySelector("#userAge").value;
    console.log(userEta);

    //calcolare il prezzo del biglietto
    let prezzoDelBiglietto = userChilometri * tariffaTicket;
